...
public class TurnoController {
    /**
     * Define un controlador TurnoController que gestiona la creación, consulta y filtrado de turnos.
     * GenericoJPA interactua con la base de datos, asi obeniendo todos loss turnos, crea nuevos turnos validando
     * la fecha y descripción, y filtra turnos por estado y fecha.
     * MAneja excepciones, asegurando la validez de los datos.
     */
